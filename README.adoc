...
ifdef::env-github[]
image::https://travis-ci.org/generator-asciidoc/generator-asciidoc.js.svg?branch=master[Build Status, link=https://travis-ci.org/generator-asciidoc/generator-asciidoc]
endif::[]
